...
export default function HomePage() {
  ...
  useEffect(() => {
    axios
      .get("http://192.168.8.106:5555/user", { withCredentials: true })
      .then((res) => {
        setUsers(res.data);
      })
      .catch((err) => {
    ...
    axios
      .get("http://192.168.8.106:5555/chat/contacts", { withCredentials: true })
      .then((res) => {
    ...
    axios
      .get("http://192.168.8.106:5555/group/getmygroups", {
    ...
    axios
      .get("http://192.168.8.106:5555/group/search", {
        withCredentials: true,
      })
      .then((res) => {
  ...
  return (
    <div className="h-full w-full flex">
      ...
      {conversation ? (
        ...
        <GroupChatBox
          groupConversation={groupConversation as GroupConversation}
        />
      ) : null}
    </div>
  );
